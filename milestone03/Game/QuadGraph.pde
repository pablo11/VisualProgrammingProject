...
class QuadGraph {
  ...
  private void build(List<PVector> lines, int width, int height) {
    int n = lines.size();
  ...
  /**
   * Returns true if polar lines 1 and 2 intersect inside an area of size (width, height)
   */
